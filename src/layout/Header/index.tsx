...
const HeaderLayout = (): React.ReactNode => {
  const [count] = useState<number>(0)

  return (
    <div className="container border-bottom fixed-top h-25" >
        <div className="row" id="header-default">
            <div className="col-10 logo d-flex justify-content-start">
                <a href="http://localhost:5173/">
                  <img src={ikiwaeLogo} className="mt-4 mb-4 h-25 img-fluid" alt="ikiwae logo" />
                </a>  
            </div>
